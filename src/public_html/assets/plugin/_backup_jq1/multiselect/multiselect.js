...
;(function (factory) {
    ...
    var Multiselect = (function($) {
        ...
        **/
        function Multiselect( $select, settings ) {
            ...
            // Hacked by Shing, 2016-09-12
           	this.$hiddenInput =	$( settings.hiddenInput ).length ? $( settings.hiddenInput ) : $('#' + id + '_hiddenInput'),
            this.actions = {
                ...
                // Hacked by Shing, 2016-09-12
                $ddmGrpSelect: $( settings.ddmSelect ).length ? $( settings.ddmGrpSelect ) : $('#' + id + '_ddmGrpSelect'),
                $reset: $( settings.reset ).length ? $( settings.reset ) : $('#' + id + '_reset')
            };
            ...
            // Hacked by Shing, 2016-09-12
            delete settings.ddmGrpSelect;
            delete settings.reset;
            delete settings.hiddenInput;
        ...
        Multiselect.prototype = {
            ...
            events: function() {
                ...
                // Hacked by Shing, 2016-09-12
                self.actions.$ddmGrpSelect.on('change', function(e) {
					var $options = self.$left.children("option[data-ddmGrpVal='" + $(this).val() + "']");
				...
				self.actions.$reset.on('click', function(e) {
					var $options = self.$right.children("option");
					...
					if (self.$hiddenInput) {
						self.$right.updateHiddenInput(self.$hiddenInput);
					}
            ...
            moveToRight: function( $options, event, silent, skipStack ) {
                ...
                if ( typeof self.callbacks.moveToRight == 'function' ) {
					...
					// Hacked by Shing, 2016-09-14, Update hidden input value after move to right
					if (self.$hiddenInput) {
						self.$right.updateHiddenInput(self.$hiddenInput);
					}
            ...
            moveToLeft: function( $options, event, silent, skipStack ) {
                ...
                if ( typeof self.callbacks.moveToLeft == 'function' ) {
					...
					// Hacked by Shing, 2016-09-14, Update hidden input value after move to left
					if (self.$hiddenInput) {
						self.$right.updateHiddenInput(self.$hiddenInput);
					}
    ...
    // Hacked by Shing, 2016-09-14
    $.fn.updateHiddenInput = function($hiddenInput) {
    	var selected = [];
